...
expected_result = {
    ...
    'token_swap_pool_ust_account': ust_pool_account,
    'token_swap_pool_st_sol_account': st_sol_pool_account,
...
expected_result = {
    ...
    'token_swap_pool_ust_account': new_ust_pool_account,
    'token_swap_pool_st_sol_account': new_st_sol_pool_account,
